...
| module.vnet_shared.azurerm_firewall_policy.this                    |                          | Threat intelligence mode is set to `Deny`.                                                       |
...
| module.vnet_shared.azurerm_network_interface.this                  |                          | Nic for `adds1` VM.                                                                               |
| module.vnet_shared.azurerm_network_security_group.groups[*]        |                          | NSGs for each subnets except `AzureFirewallSubnet`.                                               |
| module.vnet_shared.azurerm_network_security_rule.rules[*]          |                          | NSG rules for each NSG. See `locals.tf` for rule definitions.                                     |
| module.vnet_shared.azurerm_public_ip.bastion                       |                          | Public IP for Bastion host.                                                                       |
| module.vnet_shared.azurerm_public_ip.firewall                      |                          | Public IP for Azure Firewall.                                                                     |
...
| [Shared services virtual network (Part 6)](https://youtu.be/skfxxsOTEuY) | [Documentation](#documentation) |
