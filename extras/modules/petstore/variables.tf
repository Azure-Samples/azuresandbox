...
variable "container_registry_sku" {
  type        = string
  description = "The SKU name of the Azure Container Registry to create. Choose from: Basic, Standard, Premium. Premium is required for use with advanced features like geo-replication."
  default     = "Basic"

  validation {
    condition     = contains(["Basic", "Standard", "Premium"], var.container_registry_sku)
    error_message = "The container_registry_sku must be one of: Basic, Standard, Premium (case-sensitive)."
  }
}
